...
class Flight:
    ...
    def allocate_seat(self, seat, passenger):
        ...
        :param passenger: The paseenger name
...
class Aircraft:
    """Various Aircraft model details."""
...
class Boeing777(Aircraft):
    ...
    def seating_plan(self):
        # For simiplicity's sake, we ignore complex
        # seating arrabgement for first-calss
...
def make_flights():
    ...
    f.allocate_seat("15E", "Anders Hejlberg")
    f.allocate_seat("1C", "John McCarthy")
    f.allocate_seat("1D", "Rich Hickey")

    g = Flight("AF712", Boeing777("F-GSPD"))
    g.allocate_seat("55K", "Larry Wall")
    g.allocate_seat("33G", "Yukihiro Matsumoto")
    g.allocate_seat("5B", "Brian Kernighan")
    g.allocate_seat("4A", "Dennis Ritchie")
    g.allocate_seat("1D", "Jake Sully")
